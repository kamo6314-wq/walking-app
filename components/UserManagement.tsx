...
import { getAllUsers, deleteUser, deleteAllUsers } from '@/lib/supabase'
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-2">
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span className="font-bold text-green-600">{user.walking_points.toLocaleString()}pt</span>
                        </div>
                        <div className="flex items-center gap-2 text-sm">
                          <Star className="text-pink-600" size={16} />
                          <span className="text-gray-600">ガチャ:</span>
                          <span className="font-bold text-pink-600">{user.gacha_points.toLocaleString()}pt</span>
                        </div>
                      </div>

                      <div className="flex items-center gap-2 text-xs text-gray-500">
                        <Calendar size={14} />
                        登録日時: {formatDate(user.created_at)}
                      </div>
